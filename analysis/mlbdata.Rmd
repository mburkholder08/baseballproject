...
plot(mlbdata$HR,mlbdata$X2B, xlab="Home Runs", ylab="Doubles")
```
...
plot(mlbdata$HR,mlbdata$X3B, xlab="Home Runs", ylab="Triples")
```
...
plot(mlbdata$HR,mlbdata$BB, xlab="Home Runs", ylab="Walks")
```
